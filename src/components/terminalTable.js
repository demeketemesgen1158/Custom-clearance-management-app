...
export default function TerminalTable({intialDate, EndDate, awb}) {
  ...
  let totalFee = filteredData.reduce((sum, p)=>(Number(sum) + Number(p.terminalFee)), 0);
              ...
              {filteredData.map((row, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell align="left" sx={{textWrap:'noWrap'}}>{row.terminalFee}</TableCell>
                  </TableRow>
                );
              })}
              {/* {emptyRows > 0 && (
